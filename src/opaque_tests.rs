...
mod opaque_test {
    ...
    fn test_wrong_password() -> Result<(), P2POpaqueError> {
        ...
        let reg_start_resp = node_2.peer_registration_start(
            reg_start_req,
            i32_to_scalar(1),
            2,
            HashSet::from([1, 2, 3]),
        ...
        let login_start_resp = node_2.peer_login_start(
            login_start_req.clone(),
            i32_to_scalar(1),
            2,
            HashSet::from([1, 2, 3]),
    ...
    fn test_serde_req_resps() -> Result<(), P2POpaqueError> {
        ...
        let mut reg_start_resp = node_2.peer_registration_start(
            reg_start_req,
            i32_to_scalar(1),
            2,
            HashSet::from([1, 2]),
        ...
        let mut login_start_resp =
            node_2.peer_login_start(login_start_req, i32_to_scalar(1), 2, HashSet::from([1, 2]))?;
    ...
    fn test_nonexistent_envelope() -> Result<(), P2POpaqueError> {
        ...
        assert_eq!(
            node_2
                .peer_login_start(login_start_req, i32_to_scalar(1), 2, HashSet::from([1, 2]))
                .unwrap_err(),
            P2POpaqueError::RegistrationError
        );
    ...
    fn test_malicious_peer_reg_finish() -> Result<(), P2POpaqueError> {
        ...
        node_2.peer_registration_start(
            malicious_reg_start_req,
            i32_to_scalar(1),
            3,
            HashSet::from([1, 2, 3]),
        )?; // to initialize the OPRF client
